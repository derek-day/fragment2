  ...
  return (
    <>
      ...
      <div className="fixed inset-0  flex items-center justify-center px-3 sm:p-6 md:p-12 lg:p-16 pointer-events-none z-20">
        <div className="display h-auto w-full max-w-md md:max-w-4xl h-[100dvh] md:max-h-[90vh] flex flex-col bg-slate-950/95 md:bg-slate-950/80 backdrop-blur-md border border-slate-700/50 shadow-2xl overflow-hidden pointer-events-auto">
