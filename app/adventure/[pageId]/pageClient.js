    ...
    <AnimatePresence mode="wait">
      ...
      {!page.useCustomBackground && (
        ...
        {page.type !== 'battle' && page.type !== 'roll' && page.type !== 'endCard' && (
          <motion.div 
            className="story-text p-3 mb-6"
            variants={itemVariants}
            initial="hidden"
            animate="visible"
          >
            <div className="space-y-2 m-3 text-slate-100">
              {renderText()}
            </div>
          </motion.div>
        )}
        ...
        <motion.div 
          ...
          className="space-y-4 w-full max-w-2xl text-center place-items-center"
        ...
        >
          ...
          {page.choices && page.choices.map((choice, i) => (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`block choice-button w-full px-4 py-3 text-md transition-colors max-w-xs ${
          ...
          {(page.type === "stats" || 
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`continue-btn w-full px-6 py-3 font-bold text-lg transition-all max-w-xs ${
