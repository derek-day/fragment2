...
//   if (loading) return <div className="p-6 text-white">Loading journal...</div>;
//   if (!progress) return <div className="p-6 text-white">No progress data found.</div>;
...
//                     {progress.deadNPCs?.includes(npc.name) && (
//                       <span className="text-red-400 text-sm flex items-center gap-1">
//                         <Skull className="w-4 h-4" />
//                         Deceased
//                       </span>
...
//                   )}
//                   {npc.location && (
//                     <p className="text-gray-500 text-xs mt-2">Met at: {npc.location}</p>
//                   )}
//                 </div>
//               ))}
//             </div>
